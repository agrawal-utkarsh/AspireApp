...
class LmsApplicationTests {
    ...
    void submitLoanRepayment_IncorrectAmountRepaidTest() {
        SubmitLoanRepaymentRequest request = new SubmitLoanRepaymentRequest(loanId, 0D);
        try {
    ...
    void submitLoanRepayment_LoanNotFoundTest() {
        SubmitLoanRepaymentRequest request = new SubmitLoanRepaymentRequest(loanId, 10D);
        try {
